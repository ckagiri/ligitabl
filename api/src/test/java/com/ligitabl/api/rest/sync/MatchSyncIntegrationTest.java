...
class MatchSyncIntegrationTest extends AbstractPostgresIT {
    ...
    private record Fixture(
        ...
        static Fixture seed(JdbcTemplate jdbc) {
            ...
            jdbc.update(
                    "insert into t_match (pk_id, c_client_id, fk_round_id, fk_season_id, fk_home_team_id, fk_away_team_id, c_score, c_slug, c_status, c_kick_off, c_venue, c_matchday) values (?, ?, ?, ?, ?, ?, ?::jsonb, ?, ?, ?, ?, ?)",
                    matchId,
                    matchClientId,
                    roundId,
                    seasonId,
