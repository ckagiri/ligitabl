...
class GetSeasonPredictionUseCaseTest {
    ...
    @Mock
    private SeasonPredictionRankEnricher rankEnricher;
    ...
    void returns_user_prediction_when_present() {
        ...
        Either<GetSeasonPredictionError, GetSeasonPredictionResult> result = useCase.execute(userId);
    ...
    void returns_error_when_baseline_missing() {
        ...
        assertThat(result.getLeft()).isInstanceOf(GetSeasonPredictionError.BaselineRankingsMissing.class);
    }
    ...
    void returns_error_when_round_missing_for_anonymous() {
        ...
        Either<GetSeasonPredictionError, GetSeasonPredictionResult> result = useCase.execute(null);

        assertThat(result.isLeft()).isTrue();
        assertThat(result.getLeft()).isInstanceOf(GetSeasonPredictionError.CurrentRoundNotFound.class);
    ...
    void returns_error_when_season_has_no_current_round_for_user() {
        ...
        assertThat(result.isLeft()).isTrue();
        assertThat(result.getLeft()).isInstanceOf(GetSeasonPredictionError.SeasonHasNoCurrentRound.class);
        verifyNoInteractions(predictionRepo);
    }
    ...
    void returns_error_when_season_not_found() {
        ...
        assertThat(result.isLeft()).isTrue();
        assertThat(result.getLeft()).isInstanceOf(GetSeasonPredictionError.SeasonNotFound.class);
