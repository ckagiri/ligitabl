...
public class FootballDataClient {
     ...
     */
    public Either<ApiError, MatchesResponse> getMatchesForDate(
            String competitionCode,
            LocalDate date
    ) {

        log.debug("Fetching matches for date: competition={}, date={}",
                competitionCode, date);
    ...
    public Either<ApiError, MatchesResponse> getMatchesInDateRange(
        ...
        log.debug("Fetching matches in range: competition={}, from={}, to={}",
                competitionCode, dateFrom, dateTo);
    ...
    public Either<ApiError, MatchesResponse> getUpcomingMatches(String competitionCode) {
        ...
        log.debug("Fetching upcoming matches: competition={}, dateFrom={}, dateTo={}",
                competitionCode, today, dayAfterTomorrow);
        ...
        try {
            ...
            if (response == null) {
                return Either.left(new ApiError.UnknownError(
    ...
    public Either<ApiError, CompetitionResponse> getCompetition(String competitionCode) {
        ...
        try {
            ...
            log.debug("Fetched competition: name={}, currentMatchday={}",
                    response.name(),
    ...
    private <T> Either<ApiError, T> handleException(Exception e) {
        if (e instanceof WebClientResponseException.Unauthorized unauthorized) {
            ...
            return Either.left(new ApiError.Unauthorized(
                    "Invalid API token: " + unauthorized.getMessage()
            ));
