...
public record NotFoundError(String entity, String field, Object identifier, String message) implements UseCaseError {
    ...
    public NotFoundError(String entity, String field, Object identifier) {
        this(entity, field, identifier, entity + " with " + field + " " + identifier + " was not found.");
    }
